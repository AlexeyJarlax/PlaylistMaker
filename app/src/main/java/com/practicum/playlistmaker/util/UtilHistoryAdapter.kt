...
import com.practicum.playlistmaker.TrackData
    ...
    class UtilHistoryAdapter(private val context: Context, private val trackItemClickListener: OnTrackItemClickListener) {

        private val sharedPreferences: SharedPreferences =
            context.getSharedPreferences(MyCompObj.PREFS_HISTORY_NAME, Context.MODE_PRIVATE)

        private val trackAdapter = UtilTrackAdapter(context, mutableListOf(), trackItemClickListener)
...
//            getSharedPreferences(MyCompObj.PREF_SEARCH_HISTORY, Context.MODE_PRIVATE)
//        val editor = preferences.edit()
//        editor.remove(MyCompObj.PREF_KEY_SEARCH_HISTORY)
//        editor.apply()
//    }
